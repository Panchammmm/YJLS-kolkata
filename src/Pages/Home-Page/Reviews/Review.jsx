...
const Review = () => {
    ...
    return (
        <div className="bg-black py-[120px]" {...swipeHandlers}>
            <div className="container mx-auto text-center">
                ...
                <div className="flex justify-center items-center space-x-8">
                    {getVisibleTestimonials().map((testimonial, index) => (
                        <div
                            key={index}
                            className="bg-orange-500 p-6 rounded-lg shadow-lg max-w-sm transition duration-300 transform flex-shrink-0 w-[360px] h-[300px]"
                        >
                            <img
