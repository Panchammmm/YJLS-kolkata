...
const ContactForm = () => {
    ...
    return (
        <div id="contact" className="pt-[100px] pb-[120px] bg-gray-100">
            <h1 className="text-3xl font-bold capitalize text-center mb-4">Send your <span className="text-orange-500">enquiries</span></h1>
            <p className="text-center text-gray-600 mb-8">
                Feel free to keep in touch or send any enquiry.
            </p>
...
const Address = () => {
    return (
        <div className="contact-info my-auto">
            ...
            <iframe className="ml-16 mt-3" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14905.1007375459!2d88.4544983!3d22.4342955!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a02737ef7e863a3%3A0x2f0e6f81264ed215!2sYume%20Japanese%20Language%20School!5e1!3m2!1sen!2sin!4v1723487230915!5m2!1sen!2sin" width="500" height="300" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    )
}